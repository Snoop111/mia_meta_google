...
const OptimizePage = ({ onBack, question = "What can we improve?", isLoading = false, data }: OptimizePageProps) => {
  ...
  const defaultData: OptimizeData = {
    header: {
      percentage: 0,
  ...
  const displayData = optimizeData || defaultData
  return (
    <motion.div 
    ...
    >
      ...
      <div 
        ...
        style={{
          ...
          background: 'linear-gradient(180deg, rgba(255, 255, 255, 0.60) 0%, rgba(255, 255, 255, 0.00) 67.79%), #A7D3FF',
      ...
      >
        ...
        <div style={{ 
          ...
          {/* Percentage container - EXACT SAME AS GROWTH PAGE */}
          <div style={{ 
            display: 'flex', 
            alignItems: 'baseline', 
            gap: '2px',
            transform: 'translateY(30px)' // Move percentage down within header
          }}>
            <span 
              style={{
          ...
          {/* Dynamic description text - EXACT SAME AS GROWTH PAGE */}
          <div 
            style={{
              fontSize: '14px',
              ...
              <div className="relative flex items-center justify-center" style={{ width: '160px', height: '160px' }}>
                <svg width="160" height="160" viewBox="0 0 160 160" fill="none">
                  ...
                  <path 
                    ...
                    pathLength="100"
                    strokeDasharray="100"
                    strokeDashoffset={`${100 - (optimizeData?.roas?.percentage || 0)}`}
